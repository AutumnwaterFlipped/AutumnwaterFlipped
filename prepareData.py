...
def read_and_generate_dataset(graph_signal_matrix_filename,
    ...
    '''
    data_seq = np.load(graph_signal_matrix_filename)['array']  # (sequence_length, num_of_vertices, num_of_features)
...
adj_filename = 'mydata/data1120.csv'
# graph_signal_matrix_filename = data_config['graph_signal_matrix_filename']
graph_signal_matrix_filename ='mydata/mydata.npz'
...
num_of_vertices = int(157)
points_per_hour = int(4)
num_for_predict = int(4)
len_input = int(4)
